...
open class TabBarController<TabBar: TabBarCompatible>:
    UITabBarController, TabBarControllerCompatible {
    ...
    private func setupBindings() {
        ...
        //        TabBarEventBus.shared.hiddenPublisher
        //            .receive(on: DispatchQueue.main)
        //            .sink { [weak self] in self?.mainTabBar.updateHidden($0) }
        //            .store(in: &cancellables)
    }
