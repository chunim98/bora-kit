...
open class BoraCoordinator: NSObject {
    ...
    public func free(child: BoraCoordinator?) {
        children.removeAll { $0 === child }
    }
    
    /// 자식 코디네이터를 배열에 추가하여 생명주기 관리 시작
    public func store(child: BoraCoordinator) {
