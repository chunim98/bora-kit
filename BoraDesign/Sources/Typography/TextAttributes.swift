...
public struct TextAttributes {
    ...
    public var lineHeight: Metric?
    public var letterSpacing: Metric?
...
extension TextAttributes {
    ...
    public func toDictionary() -> [NSAttributedString.Key: Any] {
